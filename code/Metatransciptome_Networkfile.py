...
folder_path = 'metatransciptome_Networkfile'
...
t_count_file_path = 'metatransciptome_columnC.csv'
...
t_count_df.to_csv('metatransciptome_Networkfile/tax_15.csv', index=True)
...
t_count_df.to_csv('metatransciptome_Networkfile/tax_Betweenness.csv', index=True)
...
t_count_df.to_csv('metatransciptome_Networkfiletax_Closeness.csv', index=True)
...
t_count_df.to_csv('metatransciptome_Networkfile/tax_Page_Rank.csv', index=True)
...
for i, genome in enumerate(genomes_list, start=1):
    ...
    if phylum and genome in t_count_df.columns:
        ...
        #print(new_column_name)
        t_count_df = t_count_df.rename(columns={genome: new_column_name})
t_count_df.to_csv('metatransciptome_Networkfile/tax_Degree.csv', index=True)
...
t_count_df.to_csv('metatransciptome_Networkfile/tax_Closeness.csv', index=True)
